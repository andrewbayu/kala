  ...
  return (
    <div className="min-h-screen bg-[#0C0C14] flex flex-col items-center justify-center px-4">
      ...
      <div className="w-full max-w-sm">
        ...
        <h1 className="font-display font-light text-[28px] tracking-[-0.02em] text-[#F2EFE6] mb-2 text-center">Client Portal</h1>
        <p className="font-body font-[400] text-[14px] text-[#B8B5AA] text-center mb-8">Akses kampanye & laporan filmmu.</p>
